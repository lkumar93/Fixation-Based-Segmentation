 ...
 THIS FOLDER CONTAINS THE IMPLEMENTATION OF FIXATION BASED SEGMENTATION
 ...
 - Install MATLAB 2015 or above

 - Yuri and  Vladimir's max flow graph cut library can be installed using the following instructions
